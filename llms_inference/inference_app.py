...
def get_default_models():
    DEFAULT_MODELS = "GPT-3_5-turbo:openai;chat-completion, GPT-4:openai;chat-completion, claude-v2:anthropic;completion"
...
pat = 'add your clarifai PAT here'
...
# Get the LLM from HuggingFace for now (TODO: Fix after testing)
llm = HuggingFaceHub(
   repo_id="TinyLlama/TinyLlama-1.1B-Chat-v1.0",
   huggingfacehub_api_token = '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'
)
st.write(llm)
...
# instruction = "Complete the following Functions in Python: "
